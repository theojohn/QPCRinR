...
![image](https://github.com/theojohn/QPCRinR/assets/30171724/0188928f-b513-4fa6-abba-38f753cf6dc0)  
###### **Figure.** The results bar plot in “theme_test” and “ColPast_16” format. Timepoints define the x-axis while different colors correspond to the different treatments (FLG22 and S2). The third, -Control- defines the baseline together with the reference gene(s). Subpanels (facets) display different target genes (ACO1, PPO0 and TD20). Each bar represents the relative log2 fold-change (log2FC) estimate of each contrast, while the error bars represent the 2*SE of the estimate. Hence, comparisons whose bars cross the x-axis are not significant at α = 5 %. ######
